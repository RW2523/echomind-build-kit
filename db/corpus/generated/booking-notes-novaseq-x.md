---
title: "Booking Notes — NovaSeq X"
version: "1.0"
visibility: public
---

# Booking Notes — NovaSeq X

Practical guidance for scheduling the NovaSeq X (Genomics Core). The cancellation window, the
...
for the set-up time on a high-output sequencer.
