---
title: "Booking Notes — Aurora Spectral Analyser"
version: "1.0"
visibility: public
---

# Booking Notes — Aurora Spectral Analyser

Practical guidance for scheduling the Aurora Spectral Analyser (Flow Cytometry Core). The cancellation window, the
...
Most users book 3–5 hours. Sessions shorter than an hour rarely pay
for the set-up time on a spectral flow analyser.
