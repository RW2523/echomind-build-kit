---
title: "Booking Notes — MiSeq M3"
version: "1.0"
visibility: public
---

# Booking Notes — MiSeq M3

Practical guidance for scheduling the MiSeq M3 (Genomics Core). The cancellation window, the
...
for the set-up time on a benchtop sequencer.
